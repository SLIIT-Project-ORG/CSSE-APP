  ...
  return (
    <SafeAreaView style={{ felix: 1 }}>
        <ScrollView>
           ...
           <View>
            <TextInput style={Styles.inputfields} placeholder="User Name"></TextInput>
           </View>

           <View>
            <TextInput style={Styles.inputfields} placeholder="Password"></TextInput>
           </View>

           <View>
            <TouchableOpacity style={Styles.defaultButton1} >
                <Text style={{fontWeight:'bold' , fontSize:20, color:'white' ,textAlign:'center'}}>LOGIN</Text>
            </TouchableOpacity>
            </View>
