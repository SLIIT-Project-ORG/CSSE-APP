        ...
        {videodetails
          ...
          .map((val, key) => {
            return (
              <View style={styles.container}>
                <Card>
                  <Card.Title>{val. warehouse_name}</Card.Title>
                  
                  <Text style={{ marginBottom: 10 }}>{val.warehouse_address}</Text>
                  <Text style={{ marginBottom: 10 }}>{val.warehouse_company}</Text>
                  <Text style={{ marginBottom: 10 }}>{val.warehouse_contactno}</Text>
                  <Button
                    buttonStyle={{
