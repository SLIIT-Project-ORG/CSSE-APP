        ...
        <ScrollView>
           ...
           <View>
            <TouchableOpacity style={Styles.defaultButton1} >
                ...
                style={{fontWeight:'bold' , fontSize:20, color:'white' ,textAlign:'center'}}>Order Management</Text>
            </TouchableOpacity>
            </View>
            ...
            <TouchableOpacity style={Styles.defaultButton2} >
                ...
                style={{fontWeight:'bold' , fontSize:20, color:'white' ,textAlign:'center'}}>Add WareHouse</Text>
            </TouchableOpacity>
            </View>
            <View>
            <TouchableOpacity style={Styles.defaultButton2} >
                <Text 
                onPress={() =>
                  navigation.navigate('ManageWarehouse')
                }
                style={{fontWeight:'bold' , fontSize:20, color:'white' ,textAlign:'center'}}>WareHouse Management</Text>
            </TouchableOpacity>
            </View>
            <View>
            <TouchableOpacity style={Styles.defaultButton1} >
                ...
                style={{fontWeight:'bold' , fontSize:20, color:'white' ,textAlign:'center'}}>Add Inventory</Text>
            </TouchableOpacity>
            </View>
            <View>
            ...
            <TouchableOpacity style={Styles.defaultButton1} >
                ...
                style={{fontWeight:'bold' , fontSize:20, color:'white' ,textAlign:'center'}}>Inventry Management</Text>
            </TouchableOpacity>
            </View>
